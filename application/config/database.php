...
|	['swap_pre'] A prod table prefix that should be swapped with the dbprefix
|	['autoinit'] Whether or not to automatically initialize the database.
|	['stricton'] TRUE/FALSE - forces 'Strict Mode' connections
|							- good for ensuring strict SQL while developing
|
| The $active_group variable lets you choose which connection group to
| make active.  By prod there is only one group (the 'prod' group).
|
...
$db['dev']['password'] = 'mysql';
$db['dev']['database'] = 'viadeo_tools';
...
$db['prod']['hostname'] = 'cl2-sql2.phpnet.org';
$db['prod']['username'] = 'p1124_1';
$db['prod']['password'] = 'Creatic44';
$db['prod']['database'] = 'p1124_1';
